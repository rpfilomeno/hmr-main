...
public class ImageManager {
	...
	*/
	...
	private InputStream resizeImageStream(InputStream file, int width, int height) {
		...
		//BufferedImage scaledImg = Scalr.resize(img, Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_EXACT,  width, height); 
		BufferedImage scaledImg = getFasterScaledInstance(img, width, height, false);
