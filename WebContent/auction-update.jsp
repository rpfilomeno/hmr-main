...
<head>
	...
	<%
		System.out.println("PAGE auction-update.jsp");
        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Auctions  <label>update </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
...
*/
	...
	document.getElementById("auction_name").value = "<%=auction.getAuction_name()%>";
	document.getElementById("auction_id").value = "<%=auction.getAuction_id()%>";
	document.getElementById("auction_no").value = "<%=auction.getAuction_no()%>";
	document.getElementById("location").value = "<%=auction.getLocation()%>";
	...
	document.getElementById("start_date_time").value = "<%=start_date_time%>";
	...
	document.getElementById("end_date_time").value = "<%=end_date_time %>";
	document.getElementById("auction_desc").value = "<%=auction.getAuction_desc()%>";
	document.getElementById("category_level_1").value = "<%=auction.getCategory_level_1()%>";
	document.getElementById("auction_type").value = "<%=auction.getAuction_type()%>";
	document.getElementById("auctionStatus").value = "<%=auction.getStatus()%>";
	document.getElementById("one_lot_per_bidder").value = "<%=auction.getOne_lot_per_bidder()%>";
	document.getElementById("active").value = "<%=auction.getActive()%>";
	document.getElementById("visibility").value = "<%=auction.getVisibility()%>";
	document.getElementById("auction_item_increment_time").value = "<%=auction.getAuction_item_increment_time()%>";
	document.getElementById("bid_deposit").value = "<%=auction.getBid_deposit()%>";
	document.getElementById("bid_deposit_amount").value = "<%=auction.getBid_deposit_amount()%>";
	document.getElementById("no_of_lots").value = "<%=auction.getNo_of_lots()%>";
	document.getElementById("no_of_items").value = "<%=auction.getNo_of_items()%>";
	...
	document.getElementById("date_sync").value = "<%=date_sync%>";

	//document.getElementById("coordinator").value = "</%=auction.getCoordinator()%>";
...
function saveAuction(){
	if(validateSave()){
		document.frm.action.value="saveUpdateAuction";
		document.frm.submit();
	}
...
$(document).ready(function() {
 ...
 $(document).ready(function() {
	...
	$(document).ready(function() {
		  ...
		  $('#coordinator').select2().val(<%=auction.getCoordinator()%>);
