...
<head>
	...
	<%
	System.out.println("PAGE auction-range.jsp");
        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Auction Ranges  <label>details </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
            ...
            <div class="col-md-12">
              <div class="box box-info">
                ...
                <div class="box-body pad">
					...
					<div class="col-sm-4">
		              <div class="form-group">
		                <label><b>Range Start : </b><%=auctionRange.getRange_start() %></label>
						
		              </div>
		              <div class="form-group">
		                <label><b>Range End : </b><%=auctionRange.getRange_end() %></label>
						
		              </div>
		              <div class="form-group">
		                <label><b>Increment Amount : </b><%=auctionRange.getIncrement_amount() %></label>
				...
				<div class="col-sm-12">
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="createAuctionRange()">Create</a>
					</div>
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="updateAuctionRange()">Update</a>
					</div>
...
function createAuctionRange(){
	document.frm.action.value="createAuctionRange";
	document.frm.submit();
}

function updateAuctionRange(){
	document.frm.action.value="updateAuctionRange";
	document.frm.submit();
}
...
function saveAuctionRange(){
	if(validateSave()){
		document.frm.action.value="saveAuctionRange";
		document.frm.submit();
	}
