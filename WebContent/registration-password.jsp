        ...
        <section class="page-section color" style="padding:15px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h3 class="block-title"><span>Activate</span></h3>
                        <form action="bid" class="form-login" name="frm" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group"><input class="form-control" type="text" name="userId" placeholder="User Name or Email" maxlength="50" value="<%=userId%>"></div>
                                </div>
                                -->
                                <div class="col-md-12">
                                ...
                                --%>
                                <div class="col-md-6">
                                    <a class="btn btn-theme btn-block btn-theme-dark" href="#" onclick="submitPage()">Activate</a>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-theme btn-block btn-theme-dark" href="#" onclick="clearActivation()">Clear</a>
                                </div>
                            </div>
