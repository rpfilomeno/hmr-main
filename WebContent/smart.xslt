...
<xsl:variable name="global_font_size">8pt</xsl:variable>
          ...
          <xsl:when test="$prev">
            <td nowrap="1">
              ...
              <span class="{$fontclass}">
                <a ctype="nav.prev"
                   href="{$gsa_search_root_path_prefix}?{$search_url}&amp;start={$view_begin - $num_results - 1}" style="font-size:8pt">
          ...
          <xsl:when test="$next">
            <td nowrap="1">
              ...
              <a ctype="nav.next" href="{$gsa_search_root_path_prefix}?{$search_url}&amp;start={$view_begin +
                $num_results - 1}" style="font-size:8pt">
                <xsl:if test="$navigation_style_to_use = 'google'">
...
<xsl:template name="copyright">
  <center>
    <br/><br/>
    <p>
    <font face="arial,sans-serif" size="-1" color="#2f2f2f" style="font-size:8pt">
