        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Users  <label>update </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
					...
					<div class="col-sm-4">
		              <div class="form-group">
						...
						<input type="text" class="form-control" placeholder="FIRST NAME" value="<%=user.getFirst_name()%>" id="firstName" name="firstName" onchange="return trim(this)" autocomplete="off" maxlength="50" />
		              </div>
		              <div class="form-group">
		                <label><b>Last Name : </b></label>
						<input type="text" class="form-control" placeholder="LAST NAME" value="<%=user.getLast_name()%>"  id="lastName" name="lastName" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
		              </div>
		              <div class="form-group">
		            ...
		            %>	
						<input type="text" class="form-control" placeholder="BIRTH DATE" value="<%=birthDate%>"  id="birthDate" name="birthDate" autocomplete="off" readonly="readonly"/>
		              </div>
						<div class="form-group">
		              ...
		              <div class="form-group">
						...
						<input type="text" class="form-control" placeholder="COMPANY" value="<%=user.getCompany()!=null?user.getCompany():""%>"  id="company" name="company" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
		              </div>
						
						<div class="form-group">
							<label><b>Email Address : </b></label>
							<input type="email" class="form-control" placeholder="EMAIL ADDRESS" value="<%=user.getEmail_address()%>"  id="emailAddress" name="emailAddress" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
						</div>
						<div class="form-group">
							<label><b>Password : </b></label>
							<input type="password" class="form-control" placeholder="PASSWORD" value="<%=user.getPass_word()%>"  id="passWord" name="passWord" onchange="return trim(this)" autocomplete="off" maxlength="15"/>
						</div>
				...
				<div class="col-sm-4">
		            ...
		            %>	
						<input type="text" class="form-control" placeholder="NEWS LETTER REGISTRATION DATE" value="<%=newsLetterRegistrationDate%>" id="newsLetterRegistrationDate" name="newsLetterRegistrationDate" readonly="readonly"/>
		            </div>
					<div class="form-group">			
		            ...
		            %>	
						<input type="text" class="form-control" placeholder="REGISTRATION DATE" value="<%=dateRegistration%>" id="registrationDate" name="registrationDate" readonly="readonly"/>
		            </div>
		            <div class="form-group">
		            ...
		            %>	
						<input type="text" class="form-control" placeholder="PASSWORD CHANGE DATE" value="<%=datePasswordChange%>" id="passwordChangeDate" name="passwordChangeDate" readonly="readonly"/>
		            </div>
				...
				<div class="col-sm-4">
		              ...
		              <div class="form-group">
						...
						<input type="text" class="form-control" placeholder="MOBILE NO" value="<%=user.getMobile_no_1()%>" id="mobileNo1" name="mobileNo1" onchange="return trim(this)" autocomplete="off" maxlength="11"/>
		              </div>
		              <div class="form-group">
		                <label><b>Alternate Mobile No : </b></label>
						<input type="text" class="form-control" placeholder="ALTERNATE MOBILE NO" value="<%if(user.getMobile_no_2()!=null){ %><%=user.getMobile_no_2()%><%}%>" id="mobileNo2" name="mobileNo2" onchange="return trim(this)" autocomplete="off" maxlength="11"/>
		              </div>
		              <div class="form-group">
		                <label><b>Landline No : </b></label>
						<input type="text" class="form-control" placeholder="LANDLINE NO" value="<%if(user.getLandline_no()!=null){ %><%=user.getLandline_no()%><%}%>" id="landLineNo" name="landLineNo" onchange="return trim(this)" autocomplete="off" maxlength="11"/>
		              </div>
		              
		              <div class="form-group">
		                <label><b>Bidder No : </b></label>
						<input type="text" class="form-control" placeholder="BIDDER NO" value="<%=user.getBidder_no()%>" id="bidderNo" name="bidderNo" onchange="return trim(this)" autocomplete="off" maxlength="11"/>
		              </div>
		              
		              <div class="form-group">
		                <label><b>Reserve Bidder No : </b></label>
						<input type="text" class="form-control" placeholder="RESERVE BIDDER NO" value="<%=user.getReserve_bidder_no()%>" id="reserveBidderNo" name="reserveBidderNo" onchange="return trim(this)" autocomplete="off" maxlength="11"/>
		              </div>
		              
						<div class="form-group">
							<label><b>Verification Email Key : </b></label>
							<input type="text" class="form-control" placeholder="VERIFICATION EMAIL KEY" value="<%=user.getVerification_email_key()%>" id="verificationEmailKey" onchange="return trim(this)" name="verificationEmailKey" autocomplete="off" maxlength="15"/>
						</div>
		            <div class="form-group">
...
*/
	...
	document.getElementById("role").value="<%=user.getRole()%>";
	document.getElementById("newsLetter").value="<%=user.getNews_letter()%>";
	document.getElementById("active").value="<%=user.getActive()%>";
	document.getElementById("userStatus").value="<%=user.getStatus()%>";
	document.getElementById("showChangePasswordNextLogin").value="<%=user.getShowChangePasswordNextLogin()%>";
}
...
function saveUser(){
	if(validateSave()){
		document.frm.action.value="saveUpdateUser";
		document.frm.submit();
	}
