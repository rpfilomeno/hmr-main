							            ...
							            <div class="container">
							                <div class="row">
							                    ...
							                    <div class="col-md-7">
							                            ...
							                            <div class="media" style="height: 210px;">
							                               ...
							                               <a class="pull-left media-link" href="#" >
							                                ...
							                                <div class="media-body">
							                                    ...
							                                    <h4 class="media-heading"><a href="#" style="font-size: 14px; font-weight: bold; color: red">#<%=l.getLot_no()%>: <%=l.getLot_name()%></a></h4>
							                            ...
							                            <script>setCountDownTimer('cdTimer-<%=l.getId()%>', '<%=auction.getEnd_date_time()%>')</script>
