      ...
      <div class="content-wrapper">
		...
		<div id="msgDiv"></div>
         ...
         <div class="row invoice-info">
	    	...
	    	<input type="hidden" name="action" id="action" value="savePassword"/>
	    	...
	    	<input type="hidden" name="userLoginId" id="userLoginId" value="<%=userLogin.getId()%>"/>
              <div class="form-group">
                <label for="email_add"><b>Email Address : </b><%=userLogin.getEmail_add()%></label>
              </div>
              <div class="form-group">
         ...
         <div class="box-footer clearfix">
           <a href="#" onclick="savePassword()" class="btn btn-sm btn-info btn-flat ">Save</a>&nbsp;&nbsp;
