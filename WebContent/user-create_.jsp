  ...
  <body class="hold-transition skin-<%=SKIN_HEADER_COLOR%> sidebar-mini">
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-globe"> &nbsp; </i>New User</h3>
         ...
         <div class="row invoice-info">
	    	...
	    	<input type="hidden" name="userLoginId" id="userLoginId" value=""/>
              <div class="form-group">
				...
				<!-- <input type="text" class="form-control" placeholder="Acitve" value="" id="active" name="active"/> -->
				<select class="form-control" id="active" name="active"><option value="true">Yes</option><option value="false">No</option></select>
              </div>
              <div class="form-group">
                <label><b>First Name : </b></label>
				<input type="text" class="form-control" placeholder="First Name" value="" id="first_name" name="first_name" autocomplete="off"/>
              </div>
              <div class="form-group">
                <label><b>Last Name : </b></label>
				<input type="text" class="form-control" placeholder="Last Name" value=""  id="last_name" name="last_name" autocomplete="off"/>
              </div>
              <div class="form-group">
                <label><b>Email Address : </b></label>
				<input type="email" class="form-control" placeholder="Email Address" value=""  id="email_add" name="email_add" autocomplete="off"/>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
				...
				<input type="email" class="form-control" placeholder="Contact No" value=""  id="mobile_no" name="mobile_no" autocomplete="off"/>
              </div>
              <div class="form-group">
    ...
    <script>
 	function saveUser(){
		...
		document.getElementById("action").value="saveNewUser";
		document.frm.submit();
	}
    </script>
  </body>
