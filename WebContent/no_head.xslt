...
<xsl:value-of
    select="$gsa_resource_root_path_prefix" />http://discoverdr01:8087/discover/SiteCollectionImages/Generic/discover.jpg</xsl:variable>
...
<xsl:variable name="search_collections_xslt">0</xsl:variable>
...
<xsl:template name="logo">
    <a ctype='logo' href="http://smartnet.smart.local:8086/discover/"><img src="{$logo_url}"
      width="{$logo_width}" height="{$logo_height}"
      alt="Go to Discover Home" border="0" /></a>
</xsl:template>
...
<!-- **********************************************************************
  Collection menu beside the search box
     ********************************************************************** -->
<xsl:template name="collection_menu">  <xsl:if test="$search_collections_xslt != ''">
    <td valign="middle">
        
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='all_collection')]">
   <option value="all_collection" selected="selected">All</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="all_collection">All</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='advisories_collection')]">
   <option value="advisories_collection" selected="selected">Advisories</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="advisories_collection">Advisories</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='directories_collection')]">
   <option value="directories_collection" selected="selected">Directories</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="directories_collection">Directories</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='prepaid_collection')]">
   <option value="prepaid_collection" selected="selected">Prepaid</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="prepaid_collection">Prepaid</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='postpaid_collection')]">
   <option value="postpaid_collection" selected="selected">Postpaid</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="postpaid_collection">Postpaid</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='broadband_collection')]">
   <option value="broadband_collection" selected="selected">Broadband</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="broadband_collection">Broadband</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='finserv_collection')]">
   <option value="finserv_collection" selected="selected">FinServ</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="finserv_collection">FinServ</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='international_collection')]">
   <option value="international_collection" selected="selected">International</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="international_collection">International</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='ccareweb_collection')]">
   <option value="ccareweb_collection" selected="selected">CcareWeb</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="ccareweb_collection">CcareWeb</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='attachments_collection')]">
   <option value="attachments_collection" selected="selected">Attachments</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="attachments_collection">Attachments</option>
  </xsl:otherwise>
 </xsl:choose>
  <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='archives_collection')]">
   <option value="archives_collection" selected="selected">Archives</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="archives_collection">Archives</option>
  </xsl:otherwise>
 </xsl:choose>	
</select>
        ...
        <tr>
          ...
          <font size="-1">
            <xsl:call-template name="nbsp"/>
              ...
              <xsl:otherwise>
                <input type="submit" name="btnG" value="{$search_button_text}" style="visibility:hidden"/>
              </xsl:otherwise>
              </xsl:choose>
          </font>
          </td>
