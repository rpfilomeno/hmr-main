...
<head>
	...
	<%
		...
		User owner = request.getAttribute("owner")!=null ? (User)request.getAttribute("owner") : null;
                ...
                <div class="row" >
					...
					<div class="col-sm-4">
		              <div class="form-group">
						...
						<select class="form-control" id="user" name="user">
							<%for(User user :users){%>
								...
								<option selected="selected" value="<%=user.getId()%>"><%=user.getFirst_name() + " " + user.getLast_name() %></option>	 
								<% } else { %>
		              ...
		              <div class="form-group">
						...
						<input type="text" class="form-control" placeholder="ADDRESS LINE" value="<%=userAddress.getAddress_line_1() %>"  id="addressLine" name="addressLine" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
		              </div>
		              <div class="form-group">
		                <label><b>Baranggay </b></label>
						<input type="text" class="form-control" placeholder="BARANGGAY" value="<%=userAddress.getBaranggay() %>"  id="baranggay" name="baranggay" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
		              </div>
		              <div class="form-group">
		                <label><b>City : </b></label>
						<input type="text" class="form-control" placeholder="CITY" value="<%=userAddress.getCity() %>"  id="city" name="city" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
		              </div>
					</div>
					...
					<div class="col-sm-4">
					  <div class="form-group">
						  <div class="form-group">
							...
							<input type="text" class="form-control" placeholder="COUNTRY" value="<%=userAddress.getCountry() %>"  id="country" name="country" onchange="return trim(this)" autocomplete="off" maxlength="50"/>
			              </div>
						<label><b>Address Type : </b></label>
						<input type="number" class="form-control" placeholder="ADDRESS TYPE" value="<%=userAddress.getAddress_type() %>"  id="addressType" name="addressType" onchange="return trim(this)"/>
					  </div>
					  <div class="form-group">
						<label><b>Postal Code : </b></label>
						<input type="number" class="form-control" placeholder="POSTAL CODE" value="<%=userAddress.getPostal_code() %>"  id="postalCode" name="postalCode" onchange="return trim(this)" />
					  </div>
					</div>
					
				<div class="col-sm-12">
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="updateUserAddress()">Save</a>
					</div>
					<div class="col-sm-2">
...
function updateUserAddress(){
	if(validateSave()){
		document.frm.action.value="saveUpdateUserAddress";
		document.frm.submit();
	}
