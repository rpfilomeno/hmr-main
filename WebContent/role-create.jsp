  ...
  <body class="hold-transition skin-<%=SKIN_HEADER_COLOR%> sidebar-mini">
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-globe"> &nbsp; </i>New Role</h3>
         ...
         <div class="row invoice-info">
	    	...
	    	<input type="hidden" name="roleLoginId" id="roleLoginId" value=""/>
              <div class="form-group">
                <label><b>Role : </b></label>
				<input type="text" class="form-control" placeholder="Role" value="" id="role_name" name="role_name" autocomplete="off"/>
              </div>
              </form>
            </div><!-- /.col -->
          </div><!-- /.row -->
    ...
    <script>
 	function saveRole(){
		...
		document.getElementById("action").value="saveNewRole";
		document.frm.submit();
	}

 	document.frm.role_name.focus();
    </script>
  </body>
</html>
