...
<html>
  <head>
    ...
    <%
	    ...
	    if(ul!=null){
	    	System.out.println("PAGE user-list.jsp: ul is not null");
	    }else{
	    ...
	    List<UserLogin> ulList =(ArrayList<UserLogin>) request.getAttribute("userLoginList");
                    ...
                    <tbody>
                      ...
                      <%
                      	for(UserLogin uL : ulList){
                            ...
                            if(uL.getDate_created()!=null){
                            	date_created = sdf.format(uL.getDate_created());
                            }
                      	
                            String date_updated = "";
                            
                            if(uL.getDate_updated()!=null){
                            	date_updated = sdf.format(uL.getDate_updated());
                            }
                      
                      %>
                            <tr>
                            <td><a href="#" onclick="view('<%=uL.getId()%>')"><%=uL.getEmail_add()%></a></td>
                            <td><%=uL.getLast_name()%></td>
                            <td><%=uL.getFirst_name()%></td>
                            <td><%=uL.getActive()%></td> 
                            <td><%=date_created%></td>
                            <td><%=date_updated%></td>
                          </tr>
