          ...
          <div class="row">
            <div class="col-md-4 col-sm-1 col-xs-9">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Completed : Overriden</span>
            ...
            <div class="col-md-4 col-sm-2 col-xs-9">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Approved : Denied</span>
            ...
            <div class="col-md-4 col-sm-2 col-xs-9">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Pending : Lapse</span>
                  <span class="info-box-number">1 : 0</span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Latest 5 Requests</h3>
                     ...
                     <table class="table no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <a href="#" onclick="processAction('<%=req.getId()%>','<%=status_id%>', 'changePassword');" class="btn btn-sm btn-default btn-flat pull-left">Request Override</a>
