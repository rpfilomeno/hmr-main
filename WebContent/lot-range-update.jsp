...
<head>
	...
	<%
	System.out.println("PAGE lot-range-update.jsp");
        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Lot Ranges  <label>Update </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
            ...
            <div class="col-md-12">
              <div class="box box-info">
				...
				<div class="col-sm-12">
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="saveLotRange()">Save</a>
					</div>
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="clearLotRange()">Clear</a>
					</div>
					<div class="col-sm-2">
					     <a class="btn btn-theme btn-block " href="#" onclick="deleteLotRange()">Delete</a>
					</div>
...
*/
	...
	document.getElementById("range_start").value = "<%=lotRange.getRange_start()%>";
	document.getElementById("range_end").value = "<%=lotRange.getRange_end()%>";
	document.getElementById("increment_amount").value = "<%=lotRange.getIncrement_amount()%>";
...
function saveLotRange(){
	if(validateSave()){
		document.frm.action.value="saveUpdateLotRange";
		document.frm.submit();
	}
...
function deleteLotRange(){
	document.frm.action.value="deleteLotRange";
	document.frm.submit();
}
