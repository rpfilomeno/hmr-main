...
<html>
  <head>
    ...
    <%
		...
		ArrayList<UserLogin> ulList = (ArrayList<UserLogin>) request.getSession().getAttribute("userLoginList");
		ArrayList<ParamsLov> reqStatusParamLovList = (ArrayList<ParamsLov>) request.getSession().getAttribute("reqStatusParamLovList");
		
		
	    
	    if(ul!=null){
	    	System.out.println("PAGE request-update.jsp: ul is not null");
	    }else{
	    	System.out.println("PAGE request-update.jsp: ul is null");
	    ...
	    System.out.println("PAGE requestCur "+requestCur);
  ...
  <body class="hold-transition skin-<%=SKIN_HEADER_COLOR%> sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
         ...
         <div class="row invoice-info">
	    	...
	    	<input type="hidden" name="requestId" id="requestId" value="<%=requestCur.getId()%>"/>

              <div class="form-group">
                <label><b>User : </b></label>
				<select class="js-example-basic-user form-control" id="user_id" name="user_id" style="width:100%">
              ...
              <div class="form-group">
				...
				<select class="js-example-basic-status form-control" id="status" name="status" style="width:100%">
				  <option value=""> - Select Status - </option>
				<%for(ParamsLov plov :reqStatusParamLovList){ %>
				  <option value="<%=plov.getId()%>"><%=plov.getValue_name()%></option>
				<%}%>
				</select>
              </div>
    ...
    <script>
	  ...
	  document.getElementById("user_id").value='<%=requestCur.getUser_id()%>';
	  document.getElementById("status").value='<%=requestCur.getStatus()%>';
	...
	$(document).ready(function() {
	  ...
	  $(".js-example-basic-status").select2();
