	                    ...
	                    <div class="col-md-12">
	                        <div class="tabs-wrapper content-tabs">
	                            <ul class="nav nav-tabs">
	                                ...
	                                <li><a href="#auction-lots" data-toggle="tab">Lots</a></li>
	                                <li class="active"><a href="#items-list" data-toggle="tab">Items</a></li>
	                            ...
	                            <div class="tab-content">
							                    ...
							                    <div class="col-md-10">
							                            ...
							                            <div class="media" style="height: 210px;">
							                               <a class="pull-left media-link" href="#" >
							                                    <img  class="media-object" style="height: 200px; size: 200px;" src="image?id=<%=auction.getId()%>" alt="">
	                                ...
	                                <div class="tab-pane fade in active" id="items-list">
                        ...
                        <div class="product-list">
                            ...
                            <div class="media">
                               <a class="pull-left media-link" href="#">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading" style="font-size: 14px; font-weight: bold; color: blue"><a href="#"><%=activeOnlineAuction.getAuction_desc()%></a></h4>
                                    <%--
                                    <div class="rating">
                        ...
                        <div class="product-list">
                            ...
                            <div class="media">
                               <a class="pull-left media-link" href="#">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading" style="font-size: 14px; font-weight: bold; color: blue"><a href="#"><%=activeNegotiatedAuction.getAuction_desc()%></a></h4>
                                    <%--
                                    <div class="rating">
                                        <span class="star"></span><!--
                                        --><span class="star active"></span><!--
                                    ...
                                    <div><label>Closing : <%if(activeNegotiatedAuction.getEnd_date_time()!=null){%> <%=sdf.format(activeNegotiatedAuction.getEnd_date_time())%> <%}%> </label></div>
                                    <%-- <div class="price"><ins><%=activeOnlineAuction.getNo_of_items()%></ins></div> --%>
                                </div>
                            </div>
                            <%} %>
                            ...
                            <div class="media">
                               <a class="pull-left media-link" href="#">
                                ...
                                <div class="media-body">
                                    ...
                                    <div><label><%=activeNegotiatedAuction.getLocation()%></label></div>
                                    <div><label>Closing : <%=sdf.format(activeNegotiatedAuction.getEnd_date_time())%></label></div>
                                    <%-- <div class="price"><ins><%=activeOnlineAuction.getNo_of_items()%></ins></div> --%>
                                </div>
                            </div>
                            <%} %>
