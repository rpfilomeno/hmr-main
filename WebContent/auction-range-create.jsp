...
<head>
	...
	<%
		...
		BigDecimal auctionId_wip = request.getAttribute("auctionId_wip")!=null && !request.getAttribute("auctionId_wip").equals("") ? new BigDecimal(request.getAttribute("auctionId_wip").toString()) : new BigDecimal(request.getSession().getAttribute("auctionId-wip").toString());
        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Auction Ranges  <label>create </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
