...
<head>
	...
	<%
		System.out.println("PAGE item-list.jsp");
    ...
    <div class="content-area">
        ...
        <section class="page-section color" style="padding:15px;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Items  <label>create, list, update, delete </label></span></h3>
                      ...
                      %>
		                  <tr>
                            <td width="15px"><a href="#" onclick="view('<%=i.getId()%>')"><%=i.getItem_id()%></a></td>
