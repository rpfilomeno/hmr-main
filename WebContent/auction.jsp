        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- 
                <div id="terms_and_conditions_div">
                </div> -->
              </div><!-- /.box imageDownload?id=</%=auction.getId()%>&s=s -->
              
				<iframe id="my_iframe" style="display:none;"></iframe>
				
				<%--
	            <div class="form-group">
	              <label><b>Images Small (70 x 82): </b></label>
	              <div class="media">
	              <img class="media-object" src="image?id=<%=auction.getId()%>&s=s" alt="">
	              <a href="#" onclick="Download('imageDownload?id=<%=auction.getId()%>&s=s')">
	              <label>Download</label>
	              </a>
	              </div>
	              <div class="media">
	              	<label>Upload</label> <input type="file" id="myFileSmall" name="myFileSmall"> 
	              </div>
	            ...
	            <div class="form-group">
	              ...
	              <div class="media">
	              <img class="media-object" src="image?id=<%=auction.getId()%>" alt="">
	              <a href="#" onclick="Download('imageDownload?id=<%=auction.getId()%>')">
	              <label>Download</label>
	              </a>
	              </div>
	              <div class="media">
	              	<label>Upload</label> <input type="file" id="myFile" name="myFile"> 
	              </div>
