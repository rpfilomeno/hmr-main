...
<head>
	...
	<%
		...
		BigDecimal lotId_wip = request.getAttribute("lotId_wip")!=null && !request.getAttribute("lotId_wip").equals("") ? new BigDecimal(request.getAttribute("lotId_wip").toString()) : new BigDecimal(request.getSession().getAttribute("lotId-wip").toString());
        ...
        <section class="page-section color" style="padding:15px;">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-sm-12">
                        <h3 class="block-title"><span>Lot Ranges  <label>create </label></span></h3>
                        <div id="msgDiv"></div>
 					</div>
